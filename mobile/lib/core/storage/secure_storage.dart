...
class SecureStorage {
  ...
  static const _keyUnitId = 'unit_id';
  ...
  Future<void> saveUnitId(String id) => _write(_keyUnitId, id);
  Future<String?> getUnitId() => _read(_keyUnitId);
  ...
  Future<bool> getMustChangePassword() async {
    final v = await _read(_keyMustChangePassword);
    return v == '1';
  }
